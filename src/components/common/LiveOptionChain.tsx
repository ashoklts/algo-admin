      ...
      {!loading && data && strikes.length > 0 && (
        ...
        >
          <table className="text-xs border-collapse" style={{ tableLayout: "fixed", width: "100%" }}>
            <colgroup>
              {/* CALLS: OI Gamma Vega Theta Delta IV LTP */}
              <col style={{ width: 58 }} />
              <col style={{ width: 72 }} />
              <col style={{ width: 56 }} />
              <col style={{ width: 72 }} />
              ...
              <col style={{ width: 72 }} />
              <col style={{ width: 52 }} />
              {/* PUTS: LTP IV Delta Theta Vega Gamma OI */}
              <col style={{ width: 68 }} />
              <col style={{ width: 52 }} />
              <col style={{ width: 64 }} />
              <col style={{ width: 72 }} />
            ...
            <thead className="sticky top-0 z-20">
              {/* Section headers */}
              <tr>
                <th colSpan={7} className="py-2 text-center text-yellow-700 dark:text-yellow-400 bg-yellow-100 dark:bg-yellow-900 border-b border-gray-200 dark:border-gray-700 font-semibold tracking-wide">
                  CALLS
                </th>
                <th colSpan={2} className="py-2 text-center bg-gray-200 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300 font-semibold">
                  —
                </th>
                <th colSpan={7} className="py-2 text-center text-blue-700 dark:text-blue-400 bg-blue-100 dark:bg-blue-900 border-b border-gray-200 dark:border-gray-700 font-semibold tracking-wide">
                  PUTS
                </th>
              </tr>
              {/* Column headers */}
              <tr className="text-[10px] uppercase tracking-wide text-gray-600 dark:text-gray-300">
                {/* CALLS */}
                <th className="py-2 px-2 text-right bg-yellow-100 dark:bg-yellow-950 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">OI</th>
                <th className="py-2 px-2 text-right bg-yellow-100 dark:bg-yellow-950 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">Gamma</th>
                <th className="py-2 px-2 text-right bg-yellow-100 dark:bg-yellow-950 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">Vega</th>
                <th className="py-2 px-2 text-right bg-yellow-100 dark:bg-yellow-950 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">Theta</th>
                <th className="py-2 px-2 text-right bg-yellow-100 dark:bg-yellow-950 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">Delta</th>
                <th className="py-2 px-2 text-right bg-yellow-100 dark:bg-yellow-950 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">IV%</th>
                <th className="py-2 px-2 text-right bg-yellow-100 dark:bg-yellow-950 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">LTP</th>
                {/* Center */}
                <th className="py-2 px-2 text-center bg-gray-200 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 font-semibold text-gray-700 dark:text-gray-200 whitespace-nowrap overflow-hidden shadow-sm">Strike</th>
                <th className="py-2 px-2 text-center bg-gray-200 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">Avg IV</th>
                {/* PUTS */}
                <th className="py-2 px-2 text-left bg-blue-100 dark:bg-blue-950 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">LTP</th>
                <th className="py-2 px-2 text-left bg-blue-100 dark:bg-blue-950 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">IV%</th>
                <th className="py-2 px-2 text-left bg-blue-100 dark:bg-blue-950 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">Delta</th>
                <th className="py-2 px-2 text-left bg-blue-100 dark:bg-blue-950 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">Theta</th>
                <th className="py-2 px-2 text-left bg-blue-100 dark:bg-blue-950 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">Vega</th>
                <th className="py-2 px-2 text-left bg-blue-100 dark:bg-blue-950 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">Gamma</th>
                <th className="py-2 px-2 text-left bg-blue-100 dark:bg-blue-950 border-b border-gray-200 dark:border-gray-700 whitespace-nowrap overflow-hidden shadow-sm">OI</th>
              </tr>
            </thead>
            <tbody>
              {strikes.map(strike => {
