...
const MultiSelect: React.FC<MultiSelectProps> = ({
  ...
  useEffect(() => {
    ...
    const activeValue = selectedOptions[0] ?? options[focusedIndex]?.value;
  ...
  }, [focusedIndex, isOpen, options, selectedOptions]);
    ...
    <div className="w-full" ref={dropdownRef}>
      ...
      <div className="relative z-20 inline-block w-full">
        <div className="relative flex flex-col items-center">
          ...
          {isOpen && (
            <div
              className="absolute left-0 z-[200000] w-full overflow-y-auto rounded-lg bg-white shadow-sm top-full max-h-select dark:bg-gray-900"
